...
// of the underlying array; just assign it to a slice of itself. The capacity of a slice,
// accessible by the built-in function cap, reports the maximum length the slice may assume.
