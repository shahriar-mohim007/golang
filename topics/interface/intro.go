...
// As an example, because the empty interface doesn't require a type to have any methods at all,
// every type automatically implements the empty interface, written as:
